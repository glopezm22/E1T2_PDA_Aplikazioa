...
public class PDAfuntzionalitateak {
	...
	private static final String RUTA_LANGILE = "fitxategiak/LANGILE.txt";
    private static final String RUTA_BEZERO = "fitxategiak/BEZERO.txt";
    private static final String RUTA_BEZERO_TLF = "fitxategiak/BEZERO_TELEFONO.txt";
    private static final String RUTA_ESKARI = "fitxategiak/ESKARI.txt";
    private static final String RUTA_ESKARI_LERRO = "fitxategiak/ESKARI_LERRO.txt";
		...
		// FileReader berria sortu dugu nahi dugun fitxategia irakurtzeko eta bertatik
			...
			public static void fakturaSortu() {
				...
				try {
					...
					if (aurkituta && aurkituta2) {
						FileWriter fw = new FileWriter("fakturak/faktura_" + kodea + "_" + lerroa + ".txt");
